...
################################################################################
## Form generated from reading UI file 'untitledHxGXMz.ui'
##
...
class Ui_Menu(object):
    def setupUi(self, Menu):
        ...
        Menu.resize(844, 511)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("int.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}\n"
"")
        icon = iconodesdeBase64(MENUICON)
        #icon.addFile(u"Iconos/menu.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}\n"
"")
        icon1 = iconodesdeBase64(MINIICON)
        #icon1.addFile(u"Iconos/minimizar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}\n"
"")
        icon2 = iconodesdeBase64(RESTAICON)
...
"}\n"
"")
        icon3 = iconodesdeBase64(MAXICON)
        #icon3.addFile(u"Iconos/maximizar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}\n"
"")
        icon4 = iconodesdeBase64(EXITICON)
        #icon4.addFile(u"Iconos/boton-cerrar.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon5 = iconodesdeBase64(INICIOICON)
        ...
        icon6 = iconodesdeBase64(DEVICON)
        #icon6.addFile(u"Iconos/derivada.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_derivada.setIcon(icon6)
        ...
        icon7 = iconodesdeBase64(INTEICON)
        #icon7.addFile(u"Iconos/integral.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_integral.setIcon(icon7)
        ...
        icon8 = iconodesdeBase64(CALCULADORAINTICON)
        #icon8.addFile(u"Iconos/calculadora.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_calculadora.setIcon(icon8)
        ...
        icon9 = iconodesdeBase64(MANUALICON)
        #icon9.addFile(u"Iconos/manual.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_manual.setIcon(icon9)
        ...
        imageinicio = iconodesdeBase64Image(IMAGEHOME)
        self.label.setPixmap(QPixmap(imageinicio))
...
"}")
        ...
        self.label_int.setScaledContents(True)
...
"}")
        ...
        imagemanual = iconodesdeBase64Image(MANUALINS)
        self.label_image.setPixmap(QPixmap(imagemanual))
...
def iconodesdeBase64(base64):
        ...
        icon = QIcon(pixmap)
        return icon
def iconodesdeBase64Image(base64):
	pixmap = QPixmap()
	pixmap.loadFromData(QByteArray.fromBase64(base64))
	return pixmap